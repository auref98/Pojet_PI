...
// Méthodes add (ajouter un abjet à une liste)
	...
	/**
	 * Ajoute un objet <code>Etudiant</code> à l'objet courant. <br><br>
	 * Précondition: l'attribut "<code>listeEtudiant</code>" est initialisé avec un type valide (<code>Etudiant</code>); l'objet <code>Etudiant e</code> est correctement initialisé. <br>
	 * Postcondition: l'objet <code>Etudiant e</code> a été ajouté à l'objet courant. <br>
	 * @param e l'objet <code>Etudiant</code> à ajouter à l'objet courant
	 * @see Etudiant
	 ...
	 * Précondition: l'attribut "<code>listeContact</code>" est initialisé avec un type valide (<code>Contact</code>); l'objet <code>Contact c</code> est correctement initialisé. <br>
	...
	/**
	 * Ajoute un objet <code>Professeur</code> à l'objet courant. <br><br>
	 * Précondition: l'attribut "<code>listeProfesseur</code>" est initialisé avec un type valide (<code>Professeur</code>); l'objet <code>Professeur p</code> est correctement initialisé. <br>
	 * Postcondition: l'objet <code>Professeur p</code> a été ajouté à l'objet courant. <br>
	 * @param p l'objet <code>Professeur</code> à ajouter à l'objet courant
	 * @see Professeur
	 * @see java.util.ArrayList#add(Object o)
	 */
...
// Methodes del (Supprimer un objet d'une liste)
	 ...
	 * Précondition: l'attribut "<code>listeEtudiant</code>" est initialisé. <br>
	 * Postcondition: si l'objet <code>Etudiant e</code> se trouvait dans l'objet courant, il en a été supprimé; sinon l'objet courant est inchangé. <br>
	 * @param e l'objet <code>Etudiant</code> à supprimer de l'objet courant
	 * @see Etudiant
	 ...
	 * Précondition: l'attribut "<code>listeProf</code>" est initialisé. <br>
	 * Postcondition: si l'objet <code>Professeur p</code> se trouvait dans l'objet courant, il en a été supprimé; sinon l'objet courant est inchangé. <br>
	 * @param p l'objet <code>Professeur</code> à supprimer de l'objet courant
	 * @see Professeur
	 * @see java.util.ArrayList#remove(Object o)
	 */
